...
Parker is a self‑hosted media server for comic books (CBZ/CBR). It follows a **“Filesystem is Truth”** philosophy, parsing metadata directly from `ComicInfo.xml` inside archives. Parker is currently at **Version 0.1.31 (Stable)**.
...
- **Reader**
  ...
  - Persisted page pins and rectangle annotations with annotation peek cards, dedicated move mode, and a reader-layer visibility toggle
...
- User access control
- User-owned bookmarks and reader annotations
