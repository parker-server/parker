...
class SettingsService:
    ...
    DEFAULTS = [
        ...
        {
            "key": "enrichment.online_lookup_enabled",
            "value": "true",
            "category": "system",
            "data_type": "bool",
            "label": "Online Event Descriptions",
            "description": "Allow the Enrich Descriptions task to query Wikipedia for missing ComicInfo-derived reading-list descriptions.",
            "display_group": "Metadata Enrichment",
        },
        {
            "key": "enrichment.online_scan_lookup_enabled",
            "value": "false",
            "category": "system",
            "data_type": "bool",
            "label": "Online Event Descriptions During Scans",
            "description": "Allow scans to query Wikipedia for new ComicInfo-derived reading-list names. This is off by default to protect scan speed; curated local descriptions still run during scans.",
            "display_group": "Metadata Enrichment",
        },
        {
            "key": "enrichment.online_scan_lookup_limit",
            "value": "10",
            "category": "system",
            "data_type": "int",
            "label": "Scan Online Event Lookup Limit",
            "description": "Maximum number of new reading-list names Parker will try online per scan when online scan lookups are enabled.",
            "display_group": "Metadata Enrichment",
            "min_value": 0,
            "validation_label": "Scan online event lookup limit",
            "unit_label": "lookup",
        },
        {
