...
- Home rail headings, comic/series/volume reading controls, User Dashboard analytics/action markers, collection and reading-list surfaces, default Smart List markers, and Advanced Search saved-search controls now use subtle Lucide SVG icons instead of emoji or text glyph markers for more consistent cross-platform sizing.
...
- Clickable navigation, button, label, image, and SVG surfaces now opt out of native browser dragging or text selection to reduce accidental Chromium 153 drag-selection input freezes.
...
- Verified Home, comic/series/volume reading controls, User Dashboard, collection/reading-list surfaces, Advanced Search, and Smart List default icon behavior render Lucide SVG icons, normalize default Smart List icon persistence, and preserve Home customization plus saved-search/dashboard browser flows: `15 passed`; `7 passed` via `.\.venv\Scripts\python.exe -m pytest tests\api\test_pages.py::test_home_page_uses_lucide_rail_heading_icons tests\api\test_pages.py::test_home_smart_list_default_icon_uses_lucide_fallback tests\api\test_pages.py::test_dashboard_uses_lucide_icons_for_static_markers tests\api\test_pages.py::test_advanced_search_page_uses_lucide_saved_search_icons tests\api\test_pages.py::test_comic_detail_page_gates_file_location_and_uses_lucide_read_icons tests\api\test_pages.py::test_collection_and_reading_list_surfaces_use_lucide_icons tests\api\test_pages.py::test_series_and_volume_read_controls_use_lucide_icons tests\api\test_smart_lists.py -q` and `.\.venv\Scripts\python.exe -m pytest tests\browser\test_home_customization.py tests\browser\test_accessibility_keyboard_and_crud.py::test_saved_search_can_be_created_and_deleted tests\browser\test_saved_search_pull_list_and_session_flows.py::test_saved_search_can_be_reapplied_from_load_menu tests\browser\test_saved_search_pull_list_and_session_flows.py::test_dashboard_social_insights_prompt_dismissal_uses_namespaced_storage tests\browser\test_search_and_series_smoke.py::test_dashboard_following_page_can_unfollow_volume -q`.
