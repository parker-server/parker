...
- Verified privacy-safe recent scan job diagnostics and admin page coverage: `50 passed`.
- Verified startup stats API coverage after including recent jobs in support snapshots: `6 passed`.
